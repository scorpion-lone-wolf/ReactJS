...
function App() {
  ...
  return (
    <section>
      ...
      <Archive archObj={archObj} onAddPost={handleAddPost} />
      <Footer />
    </section>
  );
}
...
const Archive = memo(function Archive({ archObj, onAddPost }) {
  ...
  const [showArchive, setShowArchive] = useState(archObj.show);
